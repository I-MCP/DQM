...
#define CEF3_ADC_START_CHANNEL 16
#define CEF3_ADC_END_CHANNEL 19

#define HODOX_ADC_BOARD 1
#define HODOX_CHANNELS 8
#define HODOX_ADC_START_CHANNEL 0
#define HODOX_ADC_END_CHANNEL 7

#define HODOY_ADC_BOARD 1
#define HODOY_CHANNELS 8
#define HODOY_ADC_START_CHANNEL 8
#define HODOY_ADC_END_CHANNEL 15

#define CENTERX_TAGGER_ADC_BOARD 1
#define CENTERX_TAGGER_CHANNELS 2 
#define CENTERX_TAGGER_ADC_START_CHANNEL 21
#define CENTERX_TAGGER_ADC_END_CHANNEL 22

#define CENTERY_TAGGER_ADC_BOARD 1
#define CENTERY_TAGGER_CHANNELS 1 //One channel is missing
#define CENTERY_TAGGER_ADC_START_CHANNEL 20
#define CENTERY_TAGGER_ADC_END_CHANNEL 20

#define SCINT_FRONT_ADC_BOARD 1
#define SCINT_FRONT_ADC_CHANNEL 23

#define SCINT_BACK_ADC_BOARD 1
#define SCINT_BACK_ADC_CHANNEL 24
